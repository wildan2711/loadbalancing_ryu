...
class ProjectController(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        for server_ip in self.server_ips:
            ...
            outport = self.mac_to_port[server_mac]
            bucket_weight = 0
        ...
        group_id = n = random.randint(0, 2**32)
        ...
        for server_ip in self.server_ips:
            ...
            server_mac = self.arp_table[server_ip]
            outport = self.mac_to_port[server_mac]
            match = ofp_parser.OFPMatch(in_port=outport,
                eth_type=eth.ethertype,  eth_src=server_mac, eth_dst=eth.src,
                ip_proto=iphdr.proto,    ipv4_src=server_ip, ipv4_dst=iphdr.src)
